...
class Judge():
    ...
    def judge_pair(model, us_original, us_enriched):
        ...
        """
        prompt = f"""
                 Evaluate the pair {(us_original, us_enriched)} and determine whether they are expressing the same requirement.
                 Generate a JSON result containing two attributes:

                    - "result": assign the value between 0 and 1 evaluating how equivalent the requests are. How more close each other more close to 1.
